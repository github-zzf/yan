...
var app = {
	...
	bind : function() {
		...
		$('#btn_export').xbtn(function() {
			...
			var url = adminPath + '/sysTemplate/excelDownload?='+data;
			linkExcel.open("sys_template", url);
		})
	},
	load:function(){
		app.table = $('#sysTemplate_xtable').xtable({
			url:adminPath + '/sysTemplate/listPage',
			deleteUrl:adminPath + '/sysTemplate/delete',
			paging:'.sysTemplate_paging',
			format:function(row){
