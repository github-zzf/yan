...
var app = {
	...
	bind : function() {
		...
		$('#btn_export').xbtn(function() {
			...
			var url = adminPath + '/saleMember/excelDownload?='+data;
			linkExcel.open("sale_member", url);
		})
	},
	load:function(){
		app.table = $('#saleMember_xtable').xtable({
			url:adminPath + '/saleMember/listPage',
			deleteUrl:adminPath + '/saleMember/delete',
			paging:'.saleMember_paging',
			format:function(row){
