...
public class TplMsgUtils {
	 ...
	 * 消费通知
	 * 
	 * 标题 购买成功通知 {{first.DATA}} 支付时间：{{keyword1.DATA}} 订单商品：{{keyword2.DATA}}
	 * 订单金额：{{keyword3.DATA}} 订单编号：{{keyword4.DATA}} 商家信息：{{keyword5.DATA}}
	 * {{remark.DATA}}
	 */
	 ...
	 * 消耗通知
	 * 
	 * 标题 消费通知 {{first.DATA}} 本次消费项目：{{keyword1.DATA}} 剩余项目：{{keyword2.DATA}}
	 * 消费时间：{{keyword3.DATA}} 消费门店：{{keyword4.DATA}} {{remark.DATA}}
	 */
	public static final String TPL_2 = "OPENTM205704113";
	/**
	 * 预约通知
	 * 
	 * 标题 预约成功通知 {{first.DATA}} 预约内容：{{keyword1.DATA}} 预约时间：{{keyword2.DATA}}
	 * {{remark.DATA}}
	 */
	 ...
	 * 取消预约通知
	 * 
	 * 标题 取消预约成功通知 {{first.DATA}} 预约日期：{{keyword1.DATA}} 预约时间：{{keyword2.DATA}}
	 * 预约单号：{{keyword3.DATA}} {{remark.DATA}}
	 */
	public static final String TPL_4 = "OPENTM417879714";
	/**
	 * 签到通知
	 * 
	 * 标题 签到成功通知 {{first.DATA}} 签到人：{{keyword1.DATA}} 签到时间：{{keyword2.DATA}}
	 * 签到状态：{{keyword3.DATA}} {{remark.DATA}}
	 */
	public static final String TPL_5 = "OPENTM412181252";
	/**
	 * 调课通知
	 * 
	 * 标题 调课通知 {{first.DATA}} 事由：{{keyword1.DATA}} 上课时间：{{keyword2.DATA}}
	 * 调课时间：{{keyword3.DATA}} {{remark.DATA}}
	 */
	public static final String TPL_6 = "OPENTM207719530";
	/**
	 * 评价通知
	 * 
	 * 标题 服务评价通知 {{first.DATA}} 服务项目：{{keyword1.DATA}} 完成时间：{{keyword2.DATA}}
	 * {{remark.DATA}}
	 */
	 ...
	 * 会员报名提醒
	 * 
	 * 标题 报名提醒 {{first.DATA}} 姓名：{{keyword1.DATA}} 电话：{{keyword2.DATA}}
	 * 项目：{{keyword3.DATA}} 时间：{{keyword4.DATA}} {{remark.DATA}}
	 */
	public static final String TPL_9 = "OPENTM400417088";
	/**
	 * 每日统计
	 * 
	 * 标题 营业情况明细通知 {{first.DATA}} 统计时间：{{keyword1.DATA}} 营业简报：{{keyword2.DATA}}
	 * {{remark.DATA}}
	 */
	 ...
	 * 请假申请通知
	 * 
	 * 标题 请假申请通知 {{first.DATA}} 申请时间：{{keyword1.DATA}} 申请人：{{keyword2.DATA}}
	 * 请假类型：{{keyword3.DATA}} 请假开始时间：{{keyword4.DATA}} 请假结束时间：{{keyword5.DATA}}
	 * {{remark.DATA}}
	 */
	 ...
	 * 请假审批通知
	 * 
	 * 标题 审批结果通知 {{first.DATA}} 请假时间：{{keyword1.DATA}} 审批结果：{{keyword2.DATA}}
	 * {{remark.DATA}}
	 */
	 ...
	 * @return
	 */
	public static void sendMsg(String comId, String openId, String url, String tpl_code, List<String> data) {
		if (Global.isDev()) {
			return;
		}
		List<Template> tpls = ComUtils.getTemplate(comId, tpl_code);
		if (tpls != null && tpls.size() > 0) {
			...
			WxConfig c = ComUtils.getWxConfig(comId);
			if (c != null) {
				...
				try {
					...
					if (!apiResult.isSucceed()) {
						logger.error(apiResult.getErrorCode() + "=" + apiResult.getErrorMsg());
					}
				} finally {
