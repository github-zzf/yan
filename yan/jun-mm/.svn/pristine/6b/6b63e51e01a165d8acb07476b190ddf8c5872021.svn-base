...
public class ExcelUtil<T> {
    ...
    public  XSSFSheet creatAuditSheet(XSSFWorkbook workbook,String sheetName,
    ...
    public  void creatAuditSheetforMap(XSSFWorkbook workbook,String sheetName,
            List<Map<String,Object>> dataset,String[] headerColumns,String[] fieldColumns) throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public  void creatAuditSheetforDetail(XSSFWorkbook workbook,String sheetName,
            List<Map<String,Object>> dataAllo,String[] headerColumns,String[] fieldColumns,
            List<Map<String,Object>> dataDet,String[] headerColumnsDet,String[] fieldColumnsDet) throws NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
	...
	public void creatDeliveryOrder(XSSFWorkbook workbook,String sheetName, List<Map<String,Object>> dataset)
        ...
        for(Map<String,Object> t:dataset){
        	...
        	for (int i = 0; i < list.size(); i++) {
            	...
            	String[] data = {String.valueOf(i+1), pro.get("proName").toString(), pro.get("allocationNum").toString()};
