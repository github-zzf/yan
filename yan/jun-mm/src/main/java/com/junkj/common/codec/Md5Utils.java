...
import com.junkj.common.io.IOUtils;
...
public class Md5Utils {
	...
	public static String md5File(MultipartFile file) {
		try{
			byte[] bytes = DigestUtils.digest(file.getInputStream(), MD5);
	 ...
	 * shiro密码加密工具类
	 */
	public static String md5Salt(String pass, String key) {
		String saltStr = Md5Utils.md5(key);
		ByteSource salt = ByteSource.Util.bytes(saltStr);
		return new SimpleHash(MD5, pass, salt, NUM).toString();
	}
