...
@Table(name = "wx_user", alias = "a", columns = {
		...
		@Column(name = "company_id", attrName = "companyId", isUpdate = false),
		@Column(name = "appid", attrName = "appid"),
		@Column(name = "member_id", attrName = "memberId"),
		@Column(name = "del_member_id", attrName = "delMemberId"),
...
public class WxUser extends DataEntity<WxUser> {
	...
	public static final String FILE_TYPE = "wx_user_img";

	private String openid; // 用户的标识，对当前公众号唯一
	private String companyId; // 企业id
	private String appid; // appid
	private String memberId; // 会员id
	private String delMemberId; // 历史会员id
