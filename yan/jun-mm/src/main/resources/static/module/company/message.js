...
var app = {
	...
	bind : function() {
		...
		$('#btn_export').xbtn(function() {
			...
			var url = adminPath + '/message/excelDownload?='+data;
			linkExcel.open("com_message", url);
		})
	},
	load:function(){
		app.table = $('#message_xtable').xtable({
			url:adminPath + '/message/listPage',
			deleteUrl:adminPath + '/message/delete',
			paging:'.message_paging',
			format:function(row){
