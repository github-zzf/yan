...
var app = {
	...
	bind : function() {
		...
		$('#btn_export').xbtn(function() {
			...
			var url = adminPath + '/workMsg/excelDownload?='+data;
			linkExcel.open("work_msg", url);
		})
	},
	load:function(){
		app.table = $('#workMsg_xtable').xtable({
			url:adminPath + '/workMsg/listPage',
			deleteUrl:adminPath + '/workMsg/delete',
			paging:'.workMsg_paging',
			format:function(row){
