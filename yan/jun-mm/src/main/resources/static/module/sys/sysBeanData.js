...
var app = {
	...
	bind : function() {
		...
		$('#btn_export').xbtn(function() {
			...
			var url = adminPath + '/sysBeanData/excelDownload?='+data;
			linkExcel.open("sys_bean_data", url);
		})
	},
	load:function(){
		app.table = $('#sysBeanData_xtable').xtable({
			url:adminPath + '/sysBeanData/listPage',
			deleteUrl:adminPath + '/sysBeanData/delete',
			paging:'.sysBeanData_paging',
			format:function(row){
