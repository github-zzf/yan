...
var app = {
	...
	bind : function() {
		...
		$('#btn_export').xbtn(function() {
			...
			var url = adminPath + '/sysProduct/excelDownload?='+data;
			linkExcel.open("sys_product", url);
		})
	},
	load:function(){
		app.table = $('#sysProduct_xtable').xtable({
			url:adminPath + '/sysProduct/listPage',
			deleteUrl:adminPath + '/sysProduct/delete',
			paging:'.sysProduct_paging',
			format:function(row){
